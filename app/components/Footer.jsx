        ...
        <div className='mt-20 '>
            ...
            <div className='text-center sm:flex items-center justify-between border-t border-gray-400 mx-[10%] mt-12 py-6 '>
                ...
                <ul className='flex items-center gap-10 justify-center mt-4 sm:mt-0'>
                    ...
                    <li><a target='blank' href="https://github.com/Ankitsharma2023">GitHub</a></li>
                    <li><a target='blank' href="https://www.linkedin.com/in/ankitkumar8708/">Linkedln</a></li>
                    <li><a target='blank' href="https://leetcode.com/u/Ankitsharma2025/">Leetcode</a></li>
                </ul>
            </div>
        </div>
    )
